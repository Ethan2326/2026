  ...
  return (
    <div className="bg-[#FFFFFF] rounded-xl border border-[#E8E8E4] border-l-4 border-l-[#B8A060] p-4 shadow-[0_1px_3px_0_rgb(0_0_0/0.06)]">
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            {tag && (
              <span className="text-xs font-medium text-[#B8A060] bg-[#B8A060]/10 rounded-full px-2.5 py-0.5 whitespace-nowrap">
                {tag}
              </span>
            )}
          </div>
      ...
      <button
        ...
        className="mt-3 text-xs font-semibold text-[#0F0F0F]/40 hover:text-[#0F0F0F] transition-colors"
      >
        Mark done ✓
      </button>
    </div>
